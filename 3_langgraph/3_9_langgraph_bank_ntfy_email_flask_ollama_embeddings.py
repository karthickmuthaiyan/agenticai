# pip install flask pandas python-dotenv langgraph langchain-community langchain-ollama requests langchain-openai
...
# Embeddings: HuggingFace -> Ollama, local. Chat LLM: Gemini -> OpenAI gpt-4o-mini.
...
# Separate persist directory/collection from the HuggingFace version - Chroma
# collections are tied to one embedding dimensionality, and nomic-embed-text's
# vectors are a different size than all-MiniLM-L6-v2's, so they can't share a
# collection.
vectordb = Chroma(
    persist_directory=r"c:\code\agenticai\3_langgraph\banking_chromadb_ollama",
    embedding_function=embeddings,
    collection_name="banking_faqs_ollama"
)
