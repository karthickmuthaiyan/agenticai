...
def answer_question(question: str) -> BookAnswer:
    """Answer a Gutenberg question and return a validated book response.

    Flask routes can import this function and serialize the returned Pydantic
    model with ``model_dump()`` or ``model_dump_json()``.
    """
